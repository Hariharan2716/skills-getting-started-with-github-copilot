...
activities.update({
    ...
    "Swimming Team": {
        ...
        "schedule": "Tuesdays, Thursdays, Saturdays, 5:00 PM - 7:00 PM",
        "max_participants": 25,
    ...
    "Drama Society": {
        "description": "Acting, stagecraft, and regular productions",
    ...
    # Intellectual
    "Debate Team": {
        "description": "Competitive debate preparation and practice rounds",
